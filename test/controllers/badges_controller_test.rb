...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { image_path: @badge.image_path, name: @badge.name } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { image_path: @badge.image_path, name: @badge.name } }
